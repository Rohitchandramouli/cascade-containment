...
The early containment bonus decays over time — containing an outbreak on day 3 is worth more than on day 8. This design decision teaches the agent to act before crises emerge rather than after.
...
This environment is not epidemic-specific. The core mechanics — spreading cascade, delayed data, resource scarcity, spatial spillover — apply to:
...
- **Poverty intervention** — allocate aid where need is growing, not just where it is visible
